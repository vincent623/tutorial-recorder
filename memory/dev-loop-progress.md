...
- [x] `v2.8.0-commercial-release-hardening` - Add explicit AI data consent, high-impact action approval, retention payload cleanup, least-privilege CI, and commercial release governance.
